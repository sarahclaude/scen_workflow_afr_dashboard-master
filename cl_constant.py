...
class Constant:
    ...
    F_LOG                    = "log"                     # LOG file type.
    F_HTML                   = "html"                    # HTML file type.
    F_ZARR                   = "zarr"                    # ZARR file type.
    ...
    F_EXT_LOG                = "." + F_LOG               # LOG file extension.
    F_EXT_HTML               = "." + F_HTML              # HTML file extension.
    F_EXT_ZARR               = "." + F_ZARR              # ZARR file extension.
    ...
    ENS_MELCC                = "melcc"                   # MELCC.

    # Reference data.
    DATA_TYPE_STN            = "data_type_stn"           # At-a-station data.
    DATA_TYPE_GRID           = "data_type_grid"          # Gridded data.
    ...
    V_ECMWF_SNW              = "snw"                     # Snow water equivalent.
    ...
    # Variables (CANSWE).
    V_CANSWE_SND             = "snd"                     # Snow depth.
    V_CANSWE_SNW             = "snw"                     # Snow water equivalent.
    V_CANSWE = [V_CANSWE_SND, V_CANSWE_SNW]

    # Variables (MELCC).
    V_MELCC_SND             = "snd"                     # Snow depth.
    V_MELCC = [V_MELCC_SND]
    ...
    DBG_PROJECT_CODE = ""               # Project code: "<country>-<region>-<ens_ref_stn|ens_ref_grid>"
